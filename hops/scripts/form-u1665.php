...
function emailFormSubmission()
{
	...
	$to = 'contact@musetemplatesfree.com';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U1689"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$headers = 'From: contact@musetemplatesfree.com' . PHP_EOL . 'Reply-To: ' . $formEmail . PHP_EOL .'X-Mailer: Adobe Muse 2014.0.328 with PHP/' . phpversion() .'/'. PHP_OS . PHP_EOL . 'Content-type: text/html; charset=utf-8' . PHP_EOL;
